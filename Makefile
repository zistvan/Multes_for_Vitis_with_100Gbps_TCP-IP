...
#CLFLAGS += --dk chipscope:${USER_KRNL}_1:m_axis_tcp_tx_meta --dk chipscope:${USER_KRNL}_1:m_axis_tcp_tx_data --dk chipscope:${USER_KRNL}_1:s_axis_tcp_tx_status
CLFLAGS += --dk chipscope:${USER_KRNL}_1:s_axis_tcp_tx_status --dk chipscope:${USER_KRNL}_1:m_axis_udp_tx_meta
